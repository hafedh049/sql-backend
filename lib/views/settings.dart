        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(width: MediaQuery.sizeOf(context).width, height: .3, color: whiteColor.withOpacity(.3), margin: const EdgeInsets.symmetric(vertical: 20)),
                ...
                child: StatefulBuilder(
                  builder: (BuildContext context, void Function(void Function()) _) {
                    return TextField(
                      ...
                      style: GoogleFonts.itim(fontSize: 16, fontWeight: FontWeight.w500, color: whiteColor.withOpacity(.3)),
                      decoration: InputDecoration(
                        contentPadding: const EdgeInsets.all(20),
                        focusedBorder: const OutlineInputBorder(borderSide: BorderSide(color: purpleColor, width: 2, style: BorderStyle.solid)),
                        border: InputBorder.none,
                        hintText: 'Username',
                        hintStyle: GoogleFonts.itim(fontSize: 16, fontWeight: FontWeight.w500, color: whiteColor.withOpacity(.3)),
